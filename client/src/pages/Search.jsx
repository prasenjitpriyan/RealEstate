    ...
    <div className="flex flex-col md:flex-row">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              id="searchTerm"
              placeholder="Search..."
              className="border rounded-lg p-3 w-full bg-primary text-body placeholder-body"
          ...
          <div className="flex gap-2 flex-wrap items-center">
            ...
            <div className="flex gap-2">
              ...
              />
              <span className="text-secondary">Rent & Sale</span>
            </div>
            <div className="flex gap-2">
              <input
                type="checkbox"
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              id="sort_order"
              className="border rounded-lg p-3 bg-primary text-body"
            >
          ...
          <button className="bg-secondary text-body p-3 rounded-lg uppercase hover:opacity-95">
            Search
          </button>
        </form>
      </div>
      <div className="flex-1">
        ...
        <div className="p-7 flex flex-wrap gap-4">
          ...
          {loading && (
            <p className="text-xl text-secondary text-center w-full">
              Loading...
            </p>
          )}
